...
; Generated by JP GODARD on 16/04/2015 (UTC)
;
[Setup]
AppID={{c454a66c-ff6b-418a-ae63-f0c5773bbf0b}
AppName=ASCOM Spox Switch Driver
AppVerName=ASCOM Spox Switch Driver 6.1.0
AppVersion=6.1.0
AppPublisher=JP GODARD <None>
AppPublisherURL=mailto:None
...
[Files]
Source: "J:\Developpements\Projets_2015\Spox\Spox\bin\Release\ASCOM.Spox.Switch.dll"; DestDir: "{app}"
; Require a read-me HTML to appear after installation, maybe driver's Help doc
Source: "J:\Developpements\Projets_2015\Spox\Spox\ReadMe.htm"; DestDir: "{app}"; Flags: isreadme
; Optional source files (COM and .NET aware)
Source: "J:\Developpements\Projets_2015\Spox\Spox\*"; Excludes: *.zip,*.exe,*.dll, \bin\*, \obj\*; DestDir: "{app}\Source\Spox Driver"; Tasks: source; Flags: recursesubdirs
...
Filename: "{dotnet4032}\regasm.exe"; Parameters: "/codebase ""{app}\ASCOM.Spox.Switch.dll"""; Flags: runhidden 32bit
Filename: "{dotnet4064}\regasm.exe"; Parameters: "/codebase ""{app}\ASCOM.Spox.Switch.dll"""; Flags: runhidden 64bit; Check: IsWin64
